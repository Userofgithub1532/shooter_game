...
class Asteroid():
    def __init__(self,x,y,w,h,img):
        ...
        self.speed = randint(3, 7)  # - змінюємо швидкість ворогів
    def update(self):
...
class Player():
    def __init__(self,x,y,w,h,img):
        ...
        self.speed = randint(1,4)# - змінюємо швидкість ворогів
...
while run:
    ...
    text_score = pygame.font.Font(None,30).render(text,True,(77,11,155))
    text1 = "Loose: " +str(l)
    text_loose = pygame.font.Font(None, 30).render(text1, True, (77, 11, 155))
    text3 = "health:" +str(health)# змінна для життя
    text3_health = pygame.font.Font(None,30).render(text3,True,(77,11,155))
